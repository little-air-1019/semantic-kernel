...
internal class Program
{
    private static async global::System.Threading.Tasks.Task Main(string[] args)
    {
        ...
        //Azure OpenAI 
        var DeployName = Environment.GetEnvironmentVariable("AZURE_OPENAI_DEPLOY_NAME") ?? "👉模型佈署名稱👈";
        var Endpoint = Environment.GetEnvironmentVariable("AZURE_OPENAI_ENDPOINT") ?? "https://👉API端點👈.openai.azure.com/";
        var ApiKey = Environment.GetEnvironmentVariable("AZURE_OPENAI_API_KEY") ?? "👉ApiKey👈";
